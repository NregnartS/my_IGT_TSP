...
QT_MOC_LITERAL(1, 6, 11), // "textChanged"
QT_MOC_LITERAL(2, 18, 0) // ""

    },
    "Group\0textChanged\0"
};
...
void Group::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Group::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Group::textChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Group::textChanged(QString _t1)
{
